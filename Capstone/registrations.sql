...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2022 at 07:06 AM
...
INSERT INTO `response` (`Id`, `medicine`, `infected`, `quarantine`, `vaccinated`, `persons`, `cough`, `fever`, `smell`, `taste`, `tired`) VALUES
(1, 'No', 'No', 'No', 'Yes', 'No', 'No', 'No', 'No', 'No', 'Yes');
...
(0, 'Admin', 'Admin', 'adminauthority@database.com', '5b56707735bed7117162b252685a19a1', 'admin'),
(1, 'Sabangan, John Leonard M.', 'jleonard12', 'leonardsabangan@gmail.com', 'dcbfa4d3a15cdef56133a62c2d403cd4', 'user');
